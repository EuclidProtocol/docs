...
- **Tracking**: Use the [`VLP Fee`](../API%20Reference/GQL/VLP/Fee.md) or [`VLP Total Fees Collected`](../API%20Reference/GQL/VLP/Total%20Fees%20Collected.md) queries to monitor how much a pool has generated over time.
...
For fee data, combine the reserves with the [`VLP Total Fees Collected`](../API%20Reference/GQL/VLP/Total%20Fees%20Collected.md) and [`VLP Total Fees Denom`](../API%20Reference/GQL/VLP/Total%20Fees%20Denom.md) queries, which expose cumulative fees per pool (and optionally per token denomination). Factor those totals into your APR calculations alongside any incentive rewards earned over the analysis window.
