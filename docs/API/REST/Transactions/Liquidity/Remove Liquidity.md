...
| `cross_chain_addresses`   | [`CrossChainAddressWithLimit`](../../../common%20types.md#crosschainaddresswithlimit)`[]` | Optional set of addresses to specify where the assets should be released. The first element specified in the vector has highest priority and so on. Defaults to the sender.                          |
