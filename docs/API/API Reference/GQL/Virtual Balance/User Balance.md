...
|--------------|-------------------------|---------------------------------------------------------------------------------|
| `user`       | [`CrossChainUserInput`](/docs/API/API%20Reference/common%20types.md#crosschainuserinput)   | The input specifying the user for the balance query by providing the address and chain UID. |
### Return Fields
